...
- Left side: one shared input list generated from all 3 prompt templates.
- Duplicate fields such as `Primary Keyword`, `Secondary Keywords`, and `Version` appear only once.
